...
boxplot(externals$number_of_commits, internals$number_of_commits, ylim=c(0,17), xlab="# Occurrences", las = 1, outline = FALSE, cex.lab=2, cex.axis = 2, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), col=(c("#E6E6E6", "#727272")))
legend(3.5, 3, c("Internals", "Externals"), col=c("#727272", "#E6E6E6"), ncol=2, cex=2, bty = "n", fill = c("#727272", "#E6E6E6"))
